...
import (
	...
	"github.com/aiblocksproject/go-aiblocks/common/registrar"
...
// registryAPIBackend is a backend for an AiBlocks Registry.
...
// PrivateRegistarAPI offers various functions to access the AiBlocks registry.
