...
[![Build
Status](https://travis-ci.org/aiblocksproject/go-aiblocks.png?branch=master)](https://travis-ci.org/aiblocks/go-aiblocks)

The common package contains the aiblocks utility library.

# Installation

As a subdirectory the main go-aiblocks repository, you get it with
`go get github.com/aiblocksproject/go-aiblocks`.

# Usage

## RLP (Recursive Linear Prefix) Encoding

RLP Encoding is an encoding scheme used by the AiBlocks project. It
encodes any native value or list to a string.

More in depth information about the encoding scheme see the
[Wiki](http://wiki.aiblocks.org/index.php/RLP) article.
...
Patricie Tree is a merkle trie used by the AiBlocks project.

More in depth information about the (modified) Patricia Trie can be
found on the [Wiki](http://wiki.aiblocks.org/index.php/Patricia_Tree).
