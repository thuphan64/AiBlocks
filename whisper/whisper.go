...
import (
	...
	"github.com/aiblocksproject/go-aiblocks/crypto/ecies"
	"github.com/aiblocksproject/go-aiblocks/event/filter"
...
// Whisper represents a dark communication interface through the AiBlocks
...
// New creates a Whisper client ready to communicate through the AiBlocks P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
