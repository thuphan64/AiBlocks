...
// StateObject represents an AiBlocks account which is being modified.
//
...
type StateObject struct {
	...
	addrHash common.Hash // hash of aiblocks address of the account
	data     Account
	db       *StateDB
...
// Account is the AiBlocks consensus representation of accounts.
