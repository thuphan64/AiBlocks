...
// Process processes the state changes according to the AiBlocks rules by running
...
func AccumulateRewards(config *ChainConfig, statedb *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	// https://www.reddit.com/r/aiblocks/comments/3c9jbf/wtf_are_uncles_and_why_do_they_matter/
