...
package)
~/gocode/src/github.com/aiblocksproject/go-aiblocks resourceful-json-configs *% ⟠ resources -fmt -declare -var=DEFAULTS -package=assets -output=core/assets/assets.go core/config/*.json core/config/*.csv
```
