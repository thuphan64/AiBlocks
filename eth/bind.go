...
// ContractBackend implements bind.ContractBackend with direct calls to AiBlocks
// internals to support operating on contracts within subprotocols like eth and
// swarm.
//
// Internally this backend uses the already exposed API endpoints of the AiBlocks
// object. These should be rewritten to internal Go method calls when the Go API
// is refactored to support a clean library use.
type ContractBackend struct {
	eapi  *PublicAiBlocksAPI        // Wrapper around the AiBlocks object to access metadata
...
// Etheruem object.
func NewContractBackend(eth *AiBlocks) *ContractBackend {
	return &ContractBackend{
		eapi:  NewPublicAiBlocksAPI(eth),
...
// ContractCall implements bind.ContractCaller executing an AiBlocks contract
