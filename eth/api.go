...
import (
	...
	"github.com/aiblocksproject/ethash"
	"github.com/aiblocksproject/go-aiblocks/accounts"
	"github.com/aiblocksproject/go-aiblocks/common"
	"github.com/aiblocksproject/go-aiblocks/common/compiler"
	...
	"github.com/aiblocksproject/go-aiblocks/crypto"
	...
	ethMetrics "github.com/aiblocksproject/go-aiblocks/metrics"
	"github.com/aiblocksproject/go-aiblocks/miner"
	"github.com/aiblocksproject/go-aiblocks/p2p"
	"github.com/aiblocksproject/go-aiblocks/rlp"
	"github.com/aiblocksproject/go-aiblocks/rpc"
)
...
// PublicAiBlocksAPI provides an API to access AiBlocks related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicAiBlocksAPI struct {
	e   *AiBlocks
	gpo *GasPriceOracle
}

// NewPublicAiBlocksAPI creates a new AiBlocks protocol API.
func NewPublicAiBlocksAPI(e *AiBlocks) *PublicAiBlocksAPI {
	return &PublicAiBlocksAPI{
		e:   e,
		gpo: e.gpo,
	}
}
...
func (s *PublicAiBlocksAPI) GasPrice() *big.Int {
	return s.gpo.SuggestPrice()
}

// GetCompilers returns the collection of available smart contract compilers
func (s *PublicAiBlocksAPI) GetCompilers() ([]string, error) {
	solc, err := s.e.Solc()
	if err == nil && solc != nil {
...
func (s *PublicAiBlocksAPI) CompileSolidity(source string) (map[string]*compiler.Contract, error) {
	solc, err := s.e.Solc()
	if err != nil {
		return nil, err
	}
...
func (s *PublicAiBlocksAPI) Etherbase() (common.Address, error) {
	return s.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (s *PublicAiBlocksAPI) Coinbase() (common.Address, error) {
	return s.Etherbase()
}

// ProtocolVersion returns the current AiBlocks protocol version this node supports
func (s *PublicAiBlocksAPI) ProtocolVersion() *rpc.HexNumber {
	return rpc.NewHexNumber(s.e.EthVersion())
}

// Hashrate returns the POW hashrate
func (s *PublicAiBlocksAPI) Hashrate() *rpc.HexNumber {
...
func (s *PublicAiBlocksAPI) Syncing() (interface{}, error) {
...
// 61 - Mainnet $((0x3d))
// 62 - Morden $((0x3e))
func (s *PublicAiBlocksAPI) ChainId() *big.Int {
...
func NewPublicMinerAPI(e *AiBlocks) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *AiBlocks) *PrivateMinerAPI {
...
func NewPublicTxPoolAPI(e *AiBlocks) *PublicTxPoolAPI {
...
func NewPrivateAccountAPI(e *AiBlocks) *PrivateAccountAPI {
...
// Sign calculates an AiBlocks ECDSA signature for:
// keccack256("\x19AiBlocks Signed Message:\n" + len(message) + message))
//
...
//
// https://github.com/aiblocks/go-aiblocks/wiki/Management-APIs#personal_sign
...
// PublicBlockChainAPI provides an API to access the AiBlocks blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
...
func NewPublicTransactionPoolAPI(e *AiBlocks) *PublicTransactionPoolAPI {
...
//   keccak256("\x19AiBlocks Signed Message:\n"${message length}${message}).
//
// This gives context to the signed message and prevents signing of transactions.
func signHash(data []byte) []byte {
	msg := fmt.Sprintf("\x19AiBlocks Signed Message:\n%d%s", len(data), data)
...
// the address of:
// hash = keccak256("\x19AiBlocks Signed Message:\n"${message length}${message})
// addr = ecrecover(hash, signature)
//
// Note, the signature must conform to the secp256k1 curve R, S and V values, where
// the V value must be be 27 or 28 for legacy reasons.
//
// https://github.com/aiblocks/go-aiblocks/wiki/Management-APIs#personal_ecRecover
func (s *PrivateAccountAPI) EcRecover(data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != 65 {
		return common.Address{}, fmt.Errorf("signature must be 65 bytes long")
	}
	if sig[64] != 27 && sig[64] != 28 {
		return common.Address{}, fmt.Errorf("invalid AiBlocks signature (V is not 27 or 28)")
	}
...
// of the AiBlocks service.
func NewPrivateAdminAPI(eth *AiBlocks) *PrivateAdminAPI {
...
// of the AiBlocks service.
func NewPublicGethAPI(eth *AiBlocks) *PublicGethAPI {
...
func (api *PublicGethAPI) GetAddressTransactions(address common.Address, blockStartN uint64, blockEndN rpc.BlockNumber, toOrFrom string, txKindOf string, pagStart, pagEnd int, reverse bool) (list []string, err error) {
	...
	// Use human-friendly abbreviations, per https://github.com/aiblocksproject/go-aiblocks/pull/475#issuecomment-366065122
...
// NewPublicDebugAPI creates a new API definition for the public debug methods
// of the AiBlocks service.
func NewPublicDebugAPI(eth *AiBlocks) *PublicDebugAPI {
...
// See https://github.com/aiblocksproject/go-aiblocks/wiki/Metrics-and-Monitoring for prophetic documentation.
...
// Version returns the current aiblocks protocol version.
