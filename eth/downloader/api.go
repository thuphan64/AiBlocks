...
// Progress gives progress indications when the node is synchronising with the AiBlocks network.
...
// Syncing provides information when this nodes starts synchronising with the AiBlocks network and when it's finished.
