...
type BlockChain interface {
	...
	// HasBlock verifies block presence in the local chain. // NOTE(whilei): https://github.com/aiblocks/go-aiblocks/pull/16061
...
func New(mode SyncMode, stateDb ethdb.Database, mux *event.TypeMux, chain BlockChain, lightchain LightChain, dropPeer peerDropFn) *Downloader {
	...
	dl := &Downloader{
		mode:           mode,
		stateDB:        stateDb,
		mux:            mux, // inherited from protocolManager, which inherits from AiBlocks
		queue:          newQueue(),
		peers:          newPeerSet(),
