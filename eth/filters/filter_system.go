...
// package filters implements an aiblocks filtering system for block,
...
// for specific LOG events fired by the EVM (AiBlocks Virtual Machine).
...
// filterLoop waits for specific events from aiblocks and fires their handlers
