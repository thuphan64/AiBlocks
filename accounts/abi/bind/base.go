...
import (
	...
	"github.com/aiblocks/go-aiblocks/accounts/abi"
	"github.com/aiblocks/go-aiblocks/common"
	"github.com/aiblocks/go-aiblocks/core/types"
	"github.com/aiblocks/go-aiblocks/crypto"
)
...
// valid AiBlocks transaction.
type TransactOpts struct {
	From   common.Address // AiBlocks account to send the transaction from
...
// AiBlocks network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the AiBlocks blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct AiBlocks methods
...
// DeployContract deploys a contract onto the AiBlocks blockchain and binds the
