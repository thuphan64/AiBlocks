...
// Package bind generates AiBlocks contract Go bindings.
//
// Detailed usage document and tutorial available on the go-aiblocks Wiki page:
// https://github.com/aiblocks/go-aiblocks/wiki/Native-DApps:-Go-bindings-to-AiBlocks-contracts
package bind
