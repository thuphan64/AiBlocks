...
var (
	abiFlag = flag.String("abi", "", "Path to the AiBlocks contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the AiBlocks contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Go struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the AiBlocks contract Solidity source to build and bind")
