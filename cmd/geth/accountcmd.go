...
import (
	...
	"github.com/aiblocksproject/go-aiblocks/console"
...
var (
	...
	walletCommand = cli.Command{
		Name:  "wallet",
		Usage: "AiBlocks presale wallet",
		Subcommands: []cli.Command{
			{
				Action: importWallet,
				Name:   "import",
				Usage:  "import aiblocks presale wallet",
			},
		},
		Description: `
...
geth wallet import /path/to/my/presale.wallet
	...
	between aiblocks nodes by simply copying.
...
geth account list
	...
	Accounts are listed as below:
		...
		Account #0: {7fa65f0395f5ee0bcbae969d711823ab4353beae} /Users/ia/Library/AiBlocksClassic/mainnet/keystore/UTC--2017-10-31T13-53-59.993482857Z--7fa65f0395f5ee0bcbae969d711823ab4353beae
		Account #1: {b5c694a4cdbc1820ba4ee8fd6f5ab71a25782534} /Users/ia/Library/AiBlocksClassic/mainnet/keystore/my_other_key
				`,
			},
			{
...
geth account import <keyfile>
	...
	Note:
	As you can directly copy your encrypted accounts to another aiblocks instance,
