...
import (
	...
	"github.com/aiblocksproject/go-aiblocks/eth"
	"github.com/aiblocksproject/go-aiblocks/eth/downloader"
	"github.com/aiblocksproject/go-aiblocks/eth/fetcher"
...
type displayEventHandlerFn func(ctx *cli.Context, e *eth.AiBlocks, evData interface{}, tickerInterval time.Duration)
...
// what is listened for and how to respond to the given event. 'ev' is an event as received from the AiBlocks Mux subscription,
...
type displayEventHandler struct {
	...
	// (ctx *cli.Context, e *eth.AiBlocks, evData interface{}, mode *lsMode, tickerInterval time.Duration, n *uint64)
...
func (hs *displayEventHandlers) runAllIfAny(ctx *cli.Context, e *eth.AiBlocks, d interface{}, tickerInterval time.Duration, eventType logEventType) {
...
func dispatchStatusLogs(ctx *cli.Context, ethe *eth.AiBlocks) {
...
func runDisplayLogs(ctx *cli.Context, e *eth.AiBlocks, tickerInterval time.Duration, handles displayEventHandlers) {
	// Listen for events.
