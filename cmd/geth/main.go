...
// geth is the official command-line client for AiBlocks.
package main
...
import (
	...
	"github.com/aiblocksproject/benchmark/rtprof"
	...
	"github.com/aiblocksproject/go-aiblocks/metrics"
)
...
var versionCommand = cli.Command{
	Action: version,
	Name:   "version",
	Usage:  "Print aiblocks version numbers",
	Description: `
...
func makeCLIApp() (app *cli.App) {
	...
	app.Version = Version
	app.Usage = "the go-aiblocks command line interface"
	app.Action = geth
