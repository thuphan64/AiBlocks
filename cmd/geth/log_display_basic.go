...
var basicDisplaySystem = displayEventHandlers{
	{
		...
		handlers: displayEventHandlerFns{
			func(ctx *cli.Context, e *eth.AiBlocks, evData interface{}, tickerInterval time.Duration) {
...
func calcBlockDiff(e *eth.AiBlocks, lastLoggedBlockN uint64, localHead *types.Block) (blks, txs, mgas int) {
...
var PrintStatusBasic = func(e *eth.AiBlocks, tickerInterval time.Duration, insertEvent *core.ChainInsertEvent, maxPeers int) uint64 {
