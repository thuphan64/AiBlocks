...
func updateLogStatusModeHandler(ctx *cli.Context, e *eth.AiBlocks, evData interface{}, tickerInterval time.Duration) {
	currentMode = getLogStatusMode(e)
}

// getLogStatusMode gets the "mode" for the aiblocks node at any given time.
// It is used to set the global bookmark variable, and influences formatting logic.
func getLogStatusMode(e *eth.AiBlocks) lsMode {
