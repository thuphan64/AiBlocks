...
import (
	...
	"github.com/aiblocksproject/go-aiblocks/internal/jsre"
	"github.com/aiblocksproject/go-aiblocks/internal/web3ext"
...
type Config struct {
	...
	Client   rpc.Client   // RPC client to execute AiBlocks requests through
